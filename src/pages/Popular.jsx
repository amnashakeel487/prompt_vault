...
export default function Popular() {
  ...
  return (
    <section className="section-pad py-8 sm:py-14">
      ...
      <h1 className="font-display text-2xl sm:text-3xl font-semibold text-ink">Popular prompts</h1>
      <p className="mt-1 sm:mt-2 text-xs sm:text-sm text-ink-muted">Ranked by views.</p>
