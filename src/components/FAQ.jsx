        ...
        {FAQS.map((item, i) => {
          ...
          return (
            ...
            >
              ...
              >
                <span
                  className="font-display font-semibold text-sm md:text-base pr-4"
                  style={{ color: '#F4F2FF' }}
                >
                  {item.q}
                </span>
              ...
              <AnimatePresence initial={false}>
                {isOpen && (
                  ...
                  >
                    <div className="border-t border-line/50 px-5 pb-5 pt-3 text-sm text-ink-muted leading-relaxed">
                      {item.a}
                    </div>
                  </motion.div>
                )}
